...
public enum TokenType implements Serializable {
  ...
  IDENTIFIER,
  /**
   * Represents the enumerated type for the object of type {@code ByteSize} with restrictions
   * on characters that can be present in a string.
   */
  BYTE_SIZE,

  /**
   * Represents the enumerated type for the object of type {@code TimeDuration} with restrictions
   * on characters that can be present in a string.
   */
  TIME_DURATION,
}
